...
<head>
    ...
    <link rel="stylesheet" href="./style/checkout-page-style.css">
...
<div class="outte-containeer">  
        <div class="inner-containeer">
            ...
            <div class="page-title">
                <div class="checkout-info"><h4>Checkout Info</h4></div>
                ...
                <div class="user-input-containeer">
                    <div class="table-purchase">
                        ...
                        <div class="customer-details">
                            ...
                            <div class="item item2"><?php echo $_SESSION['Name']; ?></div>
                            <div class="item item3">Address</div>
                            <div class="item item4"><?php echo "No".$_SESSION['HouseNO'].", ".$_SESSION['StreetAddress'].", ".$_SESSION['City'].", ".$_SESSION['Province'];?></div>
                            <div class="item item5">Postal Code</div>
                            <div class="item item6"><?php echo $_SESSION['PostalCode']; ?></div>
                            <div class="item item7">Contact Number</div>
                            <div class="item item8"><?php echo $_SESSION['ContactNO']; ?></div>
                        </div>
                        <table class="table">
                            <thead>
                                <tr>
                    ...
                    <div class="lable-total-amount">
                        <div class="total"><Label><h4>Grand Total Amount:</h4></Label></div>
